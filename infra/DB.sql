...
-- 4. Insertar Mascotas (Se asocian a los RUTs de los cuidadores de arriba)
...
-- 5. Insertar Fichas Clínicas (Se asocian a los IDs de mascota 1, 2 y 3)
...
-- 6. Insertar Procedimientos (Se asocian a Fichas y Veterinarios)
